...
#'  repetition. \cr
#'
#' @section Selection of m-surrounding with Controlled Degree of Overlapping:
...
#'  Let us call \eqn{s_1 = s_{m-r-1}^0} and define . Take the set of
#'  nearest neighbours to \eqn{s_1}, namely, in the
#'  set of locations. \cr
#'
#' @author
#' \tabular{ll}{
